 ...
 * @returns {import('../types').MatchResult} Rastgele skorlar içeren bir MatchResult nesnesi.
 */
...
export const generateFixtures = (teams) => {
    ...
    const secondHalfFixtures = firstHalfFixtures.map(f => ({
 ...
 * @param {import('../types').Team[]} teams
 * @param {import('../types').Fixture[]} fixtures
 * @returns {import('../types').LeagueTableRow[]}
 */
export const calculateLeagueTable = (teams, fixtures) => {
    const tableData = teams.reduce((acc, team) => {
        acc[team.abbr] = {
            team,
            played: 0,
            won: 0,
 ...
 * @param {import('../types').Team[]} teams
 * @param {import('../types').Team} playerTeam
 * @returns {import('../types').Tournament}
 */
export const generateTournamentBracket = (teams, playerTeam) => {
