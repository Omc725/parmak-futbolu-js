...
const PenaltyShootout = ({ playerTeam, aiTeam, difficulty, onFinish }) => {
  const [playerOutcomes, setPlayerOutcomes] = useState([]);
  const [aiOutcomes, setAiOutcomes] = useState([]);
  const [phase, setPhase] = useState('player_shoots');
  ...
  const handleShot = (playerDirection, isPlayerShooting) => {
