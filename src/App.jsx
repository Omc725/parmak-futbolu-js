...
const App = () => {
    ...
    const [matchState, setMatchState] = useState('first_half');
    ...
    const startMatch = (team1, team2, isAI) => {
        resetMatchState();
    ...
    const handleContinueGame = (purpose) => {
    ...
    const finishMatch = useCallback(() => {
        ...
        if (selectionPurpose === 'league' && league) {
            ...
            const matchNode = currentRoundNodes.find((n) => n.team1?.abbr === currentMatch.team1.abbr && n.team2?.abbr === currentMatch.team2.abbr);
    ...
    const handlePenaltyFinish = (winner, penaltyScores) => {
        setScreen('game');
